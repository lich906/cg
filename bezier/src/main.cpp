...
{
public:
	PointsLineLayer(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3, const glm::vec2& p4, const glm::vec4& color)
		: m_mesh(
			{
				{ glm::vec3(p1, 0.0f), {}, {}, {} },
				{ glm::vec3(p2, 0.0f), {}, {}, {} },
...
{
public:
	BezierCurveLayer(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3, const glm::vec2& p4, const glm::vec4& color)
		: m_curve(p1, p2, p3, p4)
		, m_color(color)
	{
	}
