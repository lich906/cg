...
SceneLayer::SceneLayer()
	: m_program("assets/shaders/cannabis.vertex.glsl", "assets/shaders/fragment.glsl")
{
}
...
void SceneLayer::OnAttach()
{
	...
	m_program.SetUniformMatrix4fv("m_view", glm::lookAt(
		glm::vec3(0.0f, 1.0f, -4.0f), // camera pos
		glm::vec3(0.0f, 1.0f, 1.0f), // forward direction
	...
	m_objects.emplace_back(std::make_unique<Cannabis>());
}
