...
SpaceObjectFactory::CreationResult SpaceObjectFactory::CreateObjectAndView(const std::string& name, float mass, float scale, const gfx::Texture& texture, const glm::vec2& initialPosition)
{
